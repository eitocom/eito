...
Forneça um resumo das alterações realizadas neste PR e o contexto por trás delas.

---

### 🔗 Issue Relacionada

Se este PR resolve ou está associado a uma issue existente, mencione-a abaixo:
...
### 📸 Capturas de Tela / Demonstração (se houver alterações visuais)

Adicione imagens ou GIFs demonstrando a nova tela ou componente implementado.
